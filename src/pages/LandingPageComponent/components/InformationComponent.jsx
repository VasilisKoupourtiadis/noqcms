...
import RichEditor from "../../CMSComponents/RichTextEditor";
  ...
  return (
    <section className="p-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h2 className="mb-4">
            En IT-lösning för att hitta
            <span className="block"> sovplats för natten</span>
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {infoContent.map((item) => (
            <div key={item.id} className="mb-8">
              ...
              <p>{item.text}</p>
              <RichEditor text={infoContent[0].text} />
